		...
		<div className='w-screen flex'>
			<div className='w-[25%] h-screen bg-secondary overflow-scroll'>
				<div className='flex items-center my-8 mx-14'>
					<div><img src={chat} width={75} height={75} className='border border-primary p-[2px] rounded-full'alt='' /></div>
					<div className='ml-8'>
									...
									return (
										<div className='flex items-center py-8 border-b border-b-gray-300'>
											<div className='cursor-pointer flex items-center' onClick={() => fetchMessages(conversationId, user)}>
												<div><img src={av1} className="w-[60px] h-[60px] rounded-full p-[2px] border border-primary" alt='' /></div>
												<div className='ml-6'>
			...
			<div className='w-[50%] h-screen bg-white flex flex-col items-center'>
				{
					...
					<div className='w-[75%] bg-secondary h-[80px] my-14 rounded-full flex items-center px-14 py-2'>
						<div className='cursor-pointer'><img src={av1} width={60} height={60} className="rounded-full"alt='' /></div>
